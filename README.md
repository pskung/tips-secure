...
3.  กรอกรายละเอียดในหน้าต่างสร้างคีย์:
    ...
    - **Add Hostnames** > ระบุชื่อโดเมนหลักของคุณลงไป > Add > Save
      - _ตัวอย่างที่ต้องกรอก:_ `your-app.netlify.app` (ชื่อโดเมนที่ Netlify มอบให้)
...
- **ตกแต่งหน้าโดเนทอย่างไร** นำ Link ที่ได้มาเติม admin ตามหลัง ตัวอย่าง `https://your-app.netlify.app/admin` เมื่อกด Save ให้รอประมาณ 60 วินาที แล้วทำการกด Refresh หน้าหลัก จึงจะเห็นผลลัพธ์ของการตกแต่ง (สำหรับการเปลี่ยนแปลง Font ครั้งแรก จะมีการ download font เบื้องหลังประมาณ 3-4 นาที ระหว่างนั้นจะยังไม่สามารถกด save change ได้)
