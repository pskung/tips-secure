<script lang="ts">
  ...
  // 🛡️ ระบบจัดระเบียบคิว และ Auto-Google Fonts Loader เบื้องหลัง
...
>
  ...
  >
    ...
    >
      ...
      <!-- ส่วนอวาตาร์เกย 10% และขวาเป็นกลุ่มรายละเอียด -->
      <div class="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-5 sm:gap-6 px-6 -mt-3 sm:-mt-4 relative z-10 w-full">
        ...
        <div class="relative flex-shrink-0">
          ...
          <img 
            ...
            class="relative w-32 h-32 sm:w-36 sm:h-36 rounded-full border-4 border-slate-950 object-cover shadow-2xl transition-all duration-300" 
          />
        </div>

        <!-- รายละเอียดสตรีมเมอร์เว้นช่วงห่างละมุนตา space-y-4 -->
            ...
            {#each theme.socialLinks || [] as link}
              {#if link.url}
                <a 
                  ...
                  class="p-2 rounded-full border transition-all duration-300 hover:scale-115 flex items-center justify-center bg-slate-950/40"
    ...
    <div class="space-y-1.5 w-full pt-2">
      ...
      <div class="relative group">
        ...
        <input 
          ...
          type="text" 
          required 
          placeholder={theme.nicknamePlaceholder}
    ...
    <div class="space-y-1.5 w-full">
      ...
      <div class="relative group">
        ...
        <textarea 
          id="donor-msg" 
          placeholder={theme.messagePlaceholder}
          class="w-full pl-11 pr-4 py-2.5 rounded-xl text-white placeholder-slate-500 tracking-wide transition-all focus:outline-none focus:ring-2 focus:ring-transparent border" 
          rows="2" 
          style="
            background-color: {hexToRgba(theme.inputBgColor, theme.inputBgOpacity)}; 
    ...
    <div class="space-y-1.5 w-full">
      ...
      <div class="relative group">
        ...
        <input 
          ...
          required 
          min="10" 
          placeholder={theme.amountPlaceholder}
...
<style>
  /* 🛡️ สไตลิสต์คุม Placeholder ในช่องกรอกข้อมูลหลักตามที่กำหนด */
  input::placeholder,
